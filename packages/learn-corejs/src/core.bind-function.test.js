/* eslint-disable */
// node_modules/.pnpm/core-js-pure@3.33.0/node_modules/core-js-pure/internals/function-bind.js 26:20 改为 !NATIVE_BIND， 从而不用原生的 bind
...
Function.prototype.self_bind = function (context) {
  ...
  var boundFunction = function bound() {
    ...
    return this instanceof self ? self.call(self, args) : self.apply(context, args);
  };
  // no1. create mode
  // var fNOP = function () {};
...
// origin bind
var bindFoo = Child.bind(foo, 'daisy');
...
console.log('CoreJS new core_bindFoo(30) __proto__: ', new_core_bindFoo_obj.__proto__);
